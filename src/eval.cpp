...
int main(int argc, char *argv[]) {
    ...
    // //     log_column(rules[i].name, "cheap", ds_cheap.benchmark_info.rule_time[i].count());
    // //     log_column(rules[i].name, "exp", ds_exp.benchmark_info.rule_time[i].count());
    // // }
    ...
    // auto ans = DSHunter::Solver(rules).solve(g_init, sol);
